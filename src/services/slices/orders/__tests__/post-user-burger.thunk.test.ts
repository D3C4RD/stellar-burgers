...
import { postUserBurgerThunk } from '../actions';
import { ordersReducer } from '../orders-slice';
import { ordersTestInitialState } from '../../../../constants/test-order-state';
...
describe('postUserBurderThunk', () => {
  it('pending → loading: true, orderRequest: true, error: null', () => {
    const action = { type: postUserBurgerThunk.pending.type };
